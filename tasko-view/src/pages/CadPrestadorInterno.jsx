...
const CadPrestadorInterno = () => {
  const navigate = useNavigate();
  const { userId } = useParams(); // Captura o ID do usuário pela URL
    ...
    try {
      const response = await fetch("http://localhost:8080/api/prestadores", {
        ...
        body: JSON.stringify({
          ...formData,
          usuario: { id: userId },
          categoria: { id: formData.categoriaServicos },
        }),
      });
  ...
  return (
    <div>
      {/* Navbar menor */}
      <NavbarMenor link={"/configuracoes"} />
      ...
      <div className="content">
        ...
        <div className="left-side">
          ...
          <div className="overlay-text">
            <h1 className="darkBack w900">
              Cadastro de <span className="high-text">Prestador</span>
            </h1>
          </div>
        </div>
        ...
        <div className="right-side">
          <form onSubmit={handleSubmit} className="form">
            ...
            <textarea
              ...
              onChange={handleInputChange}
            ></textarea>
            <button className="button-cad" type="submit">
              Cadastrar
            </button>
          </form>
        </div>
...
export default CadPrestadorInterno;
